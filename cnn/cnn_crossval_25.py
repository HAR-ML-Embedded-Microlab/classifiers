...
model = models.load_model('point-25-sec/cnn_model')

test_windows = np.load('point-25-sec/test_windows.npy', mmap_mode='r')
test_labels = np.load('point-25-sec/test_labels.npy', mmap_mode='r')
...
# plt.ylabel('Label')
# # plt.show()
# plt.savefig('point-25-sec/cmx_25.png', dpi=300)

title = "Normalized CNN Confusion Matrix (0.25s)"
...
disp.figure_.savefig('point-25-sec/cmx_25_norm.png', dpi=300)
