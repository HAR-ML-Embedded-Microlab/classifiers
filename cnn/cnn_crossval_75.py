...
model = models.load_model('point-75-sec/cnn_model')

test_windows = np.load('point-75-sec/test_windows.npy', mmap_mode='r')
test_labels_reone = np.load('point-75-sec/test_labels_reone.npy', mmap_mode='r')
...
# plt.ylabel('Label')
# # plt.show()
# plt.savefig('point-75-sec/cmx_75.png', dpi=300)

title = "Normalized CNN Confusion Matrix (0.75s)"
...
disp.figure_.savefig('point-75-sec/cmx_75_norm.png', dpi=300)
