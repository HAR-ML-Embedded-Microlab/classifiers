...
train_windows = np.load("1-point-25-sec/train_windows.npy", mmap_mode='r')
test_windows = np.load("1-point-25-sec/test_windows.npy", mmap_mode='r')

train_features = open_memmap('1-point-25-sec/train_features.npy', mode='w+', dtype=np.float32, shape=(train_windows.shape[0], 161))
test_features = open_memmap('1-point-25-sec/test_features.npy', mode='w+', dtype=np.float32, shape=(test_windows.shape[0], 161))

fs = 62 # ~1.25s window size
