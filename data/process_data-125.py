...
train_windows = open_memmap('1-point-25-sec/train_windows_tmp.npy', mode='w+', dtype=np.float32, shape=(num_windows_train, 6, num_samples))
train_labels = open_memmap('1-point-25-sec/train_labels_tmp.npy', mode='w+', dtype=np.int32, shape=(num_windows_train,))
test_windows = open_memmap('1-point-25-sec/test_windows_tmp.npy', mode='w+', dtype=np.float32, shape=(num_windows_test, 6, num_samples))
test_labels = open_memmap('1-point-25-sec/test_labels_tmp.npy', mode='w+', dtype=np.int32, shape=(num_windows_test,))
...
with open("1-point-25-sec/class_weights.json", "w") as jsonfile:
    json.dump(class_weights, jsonfile, indent=4)   
    
print("Shuffling dataset...")

train_windows_shuffled = open_memmap('1-point-25-sec/train_windows.npy', mode='w+', dtype=np.float32, shape=(num_windows_train, 6, num_samples))
train_labels_shuffled = open_memmap('1-point-25-sec/train_labels.npy', mode='w+', dtype=np.int32, shape=(num_windows_train,))
test_windows_shuffled = open_memmap('1-point-25-sec/test_windows.npy', mode='w+', dtype=np.float32, shape=(num_windows_test, 6, num_samples))
test_labels_shuffled = open_memmap('1-point-25-sec/test_labels.npy', mode='w+', dtype=np.int32, shape=(num_windows_test,))
